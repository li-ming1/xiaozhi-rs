...
登录 [小智后台](https://xiaozhi.me/console/agents) 为你的设备配置智能体，以下组合可获得最佳体验：

- **模型** — 推荐 **DeepSeekV4（性格丰富）**：回复自然有温度、表达生动，闲聊陪伴时"人味儿"更足
- **角色音色** — 推荐 **普通话-湾湾小何 v2**：声音自然亲和、吐字清晰，听感舒适不机械

> 仅为推荐组合，可按喜好自由搭配模型与音色——全双工语音对话体验均不受影响。
